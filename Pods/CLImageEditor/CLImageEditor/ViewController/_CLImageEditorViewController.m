...
- (IBAction)pushedCancelBtn:(id)sender
{
    ...
    UIImageWriteToSavedPhotosAlbum(_originalImage,
                                   nil,
                                   nil,
                                   nil);
    ...
    self.currentTool = nil;
     ...
     /**
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Pick a screen from tab bar!"
                                                    message:@""
                                                   delegate:self
...
- (void)pushedFinishBtn:(id)sender
{
    ...
    NSLog(@"YYYYYYYYYY");
    UIImageWriteToSavedPhotosAlbum(self.targetImageView.image,
                                   nil,
                                   nil,
                                   nil);
...
- (void) close {
    ...
    PhotoViewController *p1 = [[PhotoViewController alloc] init];
    [self presentViewController:p1 animated:YES completion:nil];
     **/
    ...
    //[self presentViewController:tabBar.viewControllers[0] animated:YES completion:nil];
    //[self.navigationController popToRootViewControllerAnimated:YES];
    //[self.navigationController popViewControllerAnimated:YES];
    //[self.navigationController pushViewController:tabBar.viewControllers[0] animated:YES];
}
